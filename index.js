//Modulo 4, 2 novas funcionalidades
//Exibir a Data e Hora do Ultimo acesso do Usuario (cookies) cookies = Biscoitos
// Autenticar o usuario para controlar o acesso aos recurso da aplicação (sessão)
...
//adicionar uma nova capacidade para essa aplicaçõa: memorizar com quem o servidor está falando
//durante o uso do sistema a aplicação saberá dentro de um sessão valida, com quem ela se comunica
//https://www.npmjs.com/package/express-session
app.use(session({
  secret: "M1nhACh4M4D4",
  resave: true, //atualiza a sessao mesmo que nao ha alteraçãoes a cada requisição False: nao reseta a sessao
  saveUninitialized: true,
  cookie: {
    //tempo de vida
    maxAge: 1000 * 60 * 15 //15 minutos ocioso a sessao expira
  }
}))

app.get('/', autenticar, (requisicao, resposta) => {
  //Requisição que quero obter da lista de cookies
...
app.post('/Registrar', autenticar, processaCadastroUsuario);
app.get('/')
